 ...
 * Provides a Command-Line Interface (CLI) demonstration of the system's capabilities.
 */
public class UniversityApp {

    public static void main(String[] args) {
        // Core Setup: Initializing DAO and Service
        ...
        while (running) {
            ...
            } catch (EnrollmentException e) { // <-- FIX IS HERE: Only catching the parent class
